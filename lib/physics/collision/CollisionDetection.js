...
function earlyTest(A, B) {
  const sa = new THREE.Sphere().setFromPoints(A.convex).applyMatrix4(A.representation.matrixWorld);
  const sb = new THREE.Sphere().setFromPoints(B.convex).applyMatrix4(B.representation.matrixWorld);
