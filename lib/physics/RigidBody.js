...
import {computeBoxCollider , createBoxHelper} from "./collision/collider/OBB.js";
import {computeSphereCollider , createSphereHelper} from "./collision/collider/Sphere.js";
import {computeBVHCollider , createBVHHelper} from "./collision/collider/BVH.js";
...
class RigidBody {
    ...
    setRepresentation (object3D) {
        ...
        this.box = computeBoxCollider(this.mergedGeometry);
        this.sphere = computeSphereCollider(this.mergedGeometry);
        this.bvh = computeBVHCollider(this.mergedGeometry);
    ...
    visualizeHelper () {
        if (this.colliderType === "bvh") {
            createBVHHelper(this);
        } else if (this.colliderType === "sphere") {
            createSphereHelper(this);
        } else if (this.colliderType === "box") {
            createBoxHelper(this);
        } else {
