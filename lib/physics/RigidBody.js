...
class RigidBody {
    ...
    constructor(object3D, mass , restitution , friction , helper = true) {
        this.setRepresentation(object3D,helper);
    ...
    setRepresentation (object3D,helper) {
        ...
        if (helper) wrapper.add(createConvexHelper(this));
