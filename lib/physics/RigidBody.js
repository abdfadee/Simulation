...
import "./collision/collider/Convex.js";
...
class RigidBody {
    ...
    setRepresentation (object3D) {
        ...
        object3D.generateConvexGeometry();

        this.representation = object3D.clone();
        this.representation.bvh = object3D.bvh;
        this.representation.convex = object3D.convex;

        this.representation.createBVHHelper();
        this.representation.createConvexHelper();
